    ...
    <section className={mobileMenu ? "overlay active" : "overlay "}>
      ...
      >
        ...
        <div className='sidebar-menu-area'>
          <ul className='sidebar-menu' id='sidebar-menu'>
            ...
            <li className='sidebar-menu-group-title'>StarterPack</li>
            ...
            <li>
              <NavLink
                ...
                className={(navData) => (navData.isActive ? "active-page" : "")}
              >
                <Icon icon='solar:users-group-rounded-bold-duotone' className='menu-icon' />
            ...
            <li>
              <NavLink
                ...
                className={(navData) => (navData.isActive ? "active-page" : "")}
              >
                <Icon icon='solar:shield-user-bold-duotone' className='menu-icon' />
      ...
      >
                ...
                <div className='dropdown'>
                  ...
                  <div className='dropdown-menu to-top dropdown-menu-sm'>
                    <div className='py-12 px-16 radius-8 bg-primary-50 mb-16 d-flex align-items-center justify-content-between gap-2'>
                      ...
                      <button type='button' className='hover-text-danger' onClick={handleLogout}>
                        <Icon
        ...
        <footer className='d-footer'>
          <div className='row align-items-center justify-content-between'>
            <div className='col-auto'>
              <p className='mb-0'>© {new Date().getFullYear()} StarterPack. All Rights Reserved.</p>
            </div>
            <div className='col-auto'>
              <p className='mb-0'>
                Built with <span className='text-primary-600'>React + Laravel</span>
              </p>
            </div>
          </div>
        </footer>
